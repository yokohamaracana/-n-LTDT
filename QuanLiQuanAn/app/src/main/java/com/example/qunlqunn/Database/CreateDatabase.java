package com.example.qunlqunn.Database;
...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String tbNHANVIEN = "CREATE TABLE " + TB_NHANVIEN + " ( " + TB_NHANVIEN_MANV + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                ...
                + TB_NHANVIEN_NGAYSINH  + " TEXT, " + TB_NHANVIEN_SDT + " TEXT , " + TB_NHANVIEN_MAQUYEN + " INTEGER )";
        ...
        String tbQUYEN = "CREATE TABLE " + TB_QUYEN + " ( " + TB_QUYEN_MAQUYEN + " INTEGER PRIMARY KEY ,"
